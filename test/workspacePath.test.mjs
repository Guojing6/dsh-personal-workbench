...
test('workspacePath: isAutoTaskWorkspacePath detects task-id folders', () => {
  assert.equal(isAutoTaskWorkspacePath('C:\\Users\\me\\Documents\\dsh-workbench\\tasks\\task_abc', 'task_abc'), true)
  assert.equal(isAutoTaskWorkspacePath('/mnt/c/Users/me/Documents/dsh-workbench/tasks/task_abc/', 'task_abc'), true)
